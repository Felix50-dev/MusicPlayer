...
public class AlbumSongsAdapter extends RecyclerView.Adapter<AlbumSongsAdapter.MyViewHolder>{
    ...
    @NotNull
    @Override
    public AlbumSongsAdapter.MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull AlbumSongsAdapter.MyViewHolder holder, int position) {
